...
//                    students.addAll(data);
                    ...
                    System.out.println(STR."\uD83D\uDD8A\uFE0F Wrote data \{numberOfObject[0]} record successfully.".toUpperCase(Locale.ROOT));
                }
            }
...
//        System.out.println("Time initialized: " +(double) (endedTime-startedTime)/1000 + "s");
        Student student = new Student
                (STR."\{new Random().nextInt(10000)}CSTAD",
                        "Mouk Makara",
                        LocalDate.of(2004,12,07).toString(),
                        new String[]{"Web, Mobile app development"},
                        new String[]{"Spring boot, Flutter"},
...
//
    ...
    public void destroyData() {
        ...
        System.out.println("\uD83D\uDDD1\uFE0F Data has been cleared successfully \uD83C\uDF89\uD83E\uDD73".toUpperCase(Locale.ROOT));
    }
        ...
        if(checkIsStudentExistedById(id)){
            ...
            if(!deletedStudent.isEmpty()){
                ...
                if(opt.equalsIgnoreCase("y")){
                    ...
                    System.out.println("\uD83D\uDDD1\uFE0F User data has been deleted temporarily successfully.");
                }
